...
test('messageRawPayloadParser', async t => {
  ...
  //     uin         : 324216852,
  //   }
  //   const EXPECTED_MESSAGE_PAYLOAD_TEXT: payloads.Message = {
  //     //
  //   }
  // })
  ...
  //     uin         : 324216852,
  //   }
  //   const EXPECTED_MESSAGE_PAYLOAD_VOICE: payloads.Message = {
  //     //
  //   }
  // })
...
test('sys', async t => {
  ...
  const EXPECTED_MESSAGE_PAYLOAD_SYS: payloads.Message = {
    fromId: undefined,
...
test('room invitation created by others', async t => {
  ...
  const EXPECTED_PAYLOAD: payloads.Message = {
